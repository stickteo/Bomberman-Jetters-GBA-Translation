...
for %%G in (gfx_edit\*.bin256) do gba2bmp -B -t gfx_edit\%%~nG.bin256 -m gfx_map\%%~nG.map -b gfx_eng\%%~nG.bmp -r
...
for %%G in (gfx_edit\*.bin256) do lzss -evo gfx_edit\%%~nG.bin256
...
insert rom\output_gfx.gba gfx_edit\ban_000f1ad4.bin f1ad4
insert rom\output_gfx.gba gfx_edit\ban_001d9950.bin 1d9950
